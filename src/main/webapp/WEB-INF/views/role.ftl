...
<div id="tb">
    <div>
        ...
        <a href="javascript:openGrantDialog()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">授权</a>
    </div>
    <div>
        角色名： <input type="text" id="roleName" size="20" onkeydown="if(event.keyCode==13) searchRolesByParams()"/>
        <a href="javascript:searchRolesByParams()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
    </div>
</div>
...
<div id="grant" class="easyui-dialog" style="width:500px;height:400px;padding: 10px 20px" closed="true">
    <div>
