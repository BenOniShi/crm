...
<#--    引入 edatagrid js 文件  和   可编辑表格的渲染文件  -->
    <script type="text/javascript" src="${ctx}/static/js/sale_chance_dev.js"></script>
...
<table id="dg" title="开发计划项" style="width:700px;height:250px"
       toolbar="#toolbar" idField="id" url="${ctx}/cusDevPlan/queryCusDevPlansBySid?sid=${saleChance.id}" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">
    <thead>
    <tr>
